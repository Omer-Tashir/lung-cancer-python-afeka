...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/omertashir/Desktop/projects/lung-cancer-prediction-project/lung-cancer-prediction-server'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/omertashir/Desktop/projects/lung-cancer-prediction-project/lung-cancer-prediction-server/bin/deactivate.nu'
